...
const Main = () => {
  ...
  const [dislikeCount, setDislikeCount] = useState(0); // optional
  ...
  return (
    <div>
      <h3 className="p-3 mx-5 fw-bold fs-2">List of Blogs</h3>
      <div className="card m-4 shadow-lg p-3 mb-5 bg-body rounded">
        <div className="card-body">
          <h5 className="card-title">Blog Title</h5>
          <p className="card-text">
            Todays vibe — Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
          ...
          <div className="border-top p-3" style={{ height: "40px" }}>
            <div className="d-flex justify-content-center align-items-center gap-3">
              ...
              <button className="border-0 bg-transparent" style={{ outline: "none" }}>
